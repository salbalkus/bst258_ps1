...
```{math}
\begin{align*}
E(\theta^{ATT}) = \frac{1}{n}\sum_{i=1}^nE(A_i(Y_i(1) - Y_i(0)))\\
= E(A_i Y_i(1) - (1 - A_i)Y_i(0))\\
= \frac{m}{n} E(Y_i(1)) - (1 - \frac{m}{n})E(Y_i(0))
\end{align*}
```

So, $E(\theta^{ATT}) = \frac{m}{n} E(Y_i(1)) - (1 - \frac{m}{n})E(Y_i(0))$.
